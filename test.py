...
a = AB
b = BC
v = 0.331 # скорость звука. можно сделать от температуры
#dt1 = tb-ta
#dt2 = tc-ta
...
xx1 = (c1-(b1*xx2))/a1
d = xx1 # расстояние до цели в метрах

dd = math.fabs(d) # из минуса в плюс

cosX = ((c1-(a1*d))/(b1*d))
#cosX2 = math.fabs(cosX) # из минуса в плюс
l=math.acos(cosX)*(180/math.pi) # из радианов в градусы, угол в градусах
...
# РАСЧЕТ КООРДИНАТ ЦЕЛEЙ

#УСЛОВИЯ НА ПРОТИВНИКА (180-l)
dx = dd * math.cos(math.radians(l))
dy = dd * math.cos(math.radians(180-l))

dx1=dx/yyy #маштабирование
dy1=dy/xxx #маштабирование
x5 = x1 + dx1      #от базового поста x1 y1,
y5 = y1 +dy1
